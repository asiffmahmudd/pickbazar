...
const UserOrderDetails = ({orderDetails}) => {
    ...
    else if(orderDetails?.status.toLowerCase() === "processing"){
        barWidth = "75%"
    }
    else if(orderDetails?.status.toLowerCase() === "delivered"){
        barWidth = "100%"
    }
        ...
        <div className="user-order-details border bg-white">
            ...
            <div className="row border-top border-bottom" style={{margin:'0'}}>
                <div className="col-lg-8 border-right pt-3">
                    ...
                    <p className="address-details">{orderDetails?.delivery_address}</p>
                </div>
            ...
            <div className="table-responsive" style={{padding:'0'}}>
                <table className="table table-borderless">
                    ...
                    <tbody>
                        {
                            orderDetails?.products?.map((pd,index) => {
                                console.log(orderDetails)
                                return (
                                    <tr key={index}>
                                        <td>
                                            <img src={orderDetails.img?.length > 0 && orderDetails.img[0].img} alt="" style={{height:'60px',width:'60px',}}/>
                                        </td>
                                        <td>
                                            <p>{pd.item_name}</p>
